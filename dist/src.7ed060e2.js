...
var API_KEY = '325a8c42c5e6f2dea4d134907ec709d4';
...
var GetDataApi = /*#__PURE__*/function () {
  ...
  _createClass(GetDataApi, [{
    key: "getDate",
    value: function () {
      var _getDate = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(url) {
        var response;
...
var Error = /*#__PURE__*/function () {
  ...
  _createClass(Error, [{
    ...
    value: function render() {
      ...
      _root.ROOT_INDEX.innerHTML = htmlWrap;
    }
  }]);
...
},{"../../constans/root":"../src/constans/root.js","./Error.css":"../src/components/Error/Error.css"}],"../src/components/Comics/Comics.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../src/components/Characters/Characters.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
var Characters = /*#__PURE__*/function () {
  ...
  _createClass(Characters, [{
    ...
    key: "render",
    value: function () {
      var _render = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(url) {
        var data;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _getDataApi.getDataApi.getDate(url);
...
exports.default = _default;
},{"../../constans/root":"../src/constans/root.js","../../utils/getDataApi":"../src/utils/getDataApi.js","./Characters.css":"../src/components/Characters/Characters.css"}],"../src/components/Spinner/Spinner.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../src/components/Spinner/spinner.svg":[function(require,module,exports) {
module.exports = "/spinner.23f8ee5a.svg";
},{}],"../src/components/Spinner/Spinner.js":[function(require,module,exports) {
"use strict";
...
var Spinner = /*#__PURE__*/function () {
  ...
  _createClass(Spinner, [{
    key: "render",
    value: function render() {
      var html = "\n\t\t\t<div class=\"container-spinner\" style=\"background-image: url(".concat(_spinner.default, ")\">\n\t\t\t</div>\n\t\t");
      _root.ROOT_MODAL.innerHTML = html;
    }
  }]);
...
exports.default = _default;
},{"../../constans/root":"../src/constans/root.js","./Spinner.css":"../src/components/Spinner/Spinner.css","./spinner.svg":"../src/components/Spinner/spinner.svg"}],"../src/components/Comics/Comics.js":[function(require,module,exports) {
"use strict";
...
var Comics = /*#__PURE__*/function () {
  ...
  _createClass(Comics, [{
    ...
    value: function renderComics(data) {
      var htmlCard = '';
      var comics = data.map(function (_ref) {
        var id = _ref.id,
            title = _ref.title,
            _ref$thumbnail = _ref.thumbnail,
            extension = _ref$thumbnail.extension,
        ...
        return !arr.path.includes('image_not_available');
      });
      comics.forEach(function (_ref2) {
        var id = _ref2.id,
            title = _ref2.title,
            extension = _ref2.extension,
            path = _ref2.path;
        var url = "".concat(_api.API_URL).concat(_api.URL_COMICS, "/").concat(id, "/").concat(_api.URL_CHARACTERS);
        htmlCard += "\n\t\t\t\t<li class=\"comics__item\" data-url=".concat(url, ">\n\t\t\t\t\t<span class=\"comics__name\">").concat(title, "</span> \n\t\t\t\t\t<img class=\"comics__img\" src=").concat(path, "/standard_xlarge.").concat(extension, " alt=\"photo character\" />\n\t\t\t\t</li>\n\t\t\t");
      });
      _root.ROOT_INDEX.innerHTML = "\n\t\t\t<ul class=\"comics-container\">\n\t\t\t\t".concat(htmlCard, "\n\t\t\t</ul>\n\t\t");
    }
  }, {
    key: "openCharacter",
    value: function openCharacter() {
      document.querySelectorAll('.comics__item').forEach(function (element) {
        var url = element.getAttribute('data-url');
        element.addEventListener('click', function () {
          _Spinner.default.render();

          _Characters.default.render(url);
        });
      });
    }
  }, {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _getDataApi.getDataApi.getDate(_api.API_URL + _api.URL_COMICS);
...
exports.default = _default;
},{"../../utils/getDataApi":"../src/utils/getDataApi.js","../../constans/api":"../src/constans/api.js","../../constans/root":"../src/constans/root.js","../Error/Error":"../src/components/Error/Error.js","./Comics.css":"../src/components/Comics/Comics.css","../Characters/Characters":"../src/components/Characters/Characters.js","../Spinner/Spinner":"../src/components/Spinner/Spinner.js"}],"../src/components/App/App.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
